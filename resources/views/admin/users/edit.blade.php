            ...
            <div class="control">
                <div class="select">
                    <select name="category" required>
                        ...
                        <option value="" {{ $post->category === 'html' ? 'selected' : null }}>HTML</option>
                        <option value="" {{ $post->category === 'css' ? 'selected' : null }}>CSS</option>
                        <option value="" {{ $post->category === 'javascript' ? 'selected' : null }}>JavaScript</option>
                        <option value="" {{ $post->category === 'php' ? 'selected' : null }}>PHP</option>
                    </select>
                </div>
            </div>
        </div>
